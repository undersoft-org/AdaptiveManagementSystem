...
namespace Undersoft.AMS.Catalog.Service.Application.GUI.Compound.Graphic;

/// <summary>
/// The logo SCC.
/// </summary>
public class LogoAll.Catalog : Icon
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LogoAll.Catalog"/> class.
    /// </summary>
    public LogoAll.Catalog()
        : base(
            "Undersoft",
            IconVariant.Regular,
            IconSize.Custom,
