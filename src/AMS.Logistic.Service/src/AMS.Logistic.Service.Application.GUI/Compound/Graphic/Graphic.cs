...
namespace Undersoft.AMS.Logistic.Service.Application.GUI.Compound.Graphic;

/// <summary>
/// The logo SCC.
/// </summary>
public class LogoAll.Logistic : Icon
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LogoAll.Logistic"/> class.
    /// </summary>
    public LogoAll.Logistic()
        : base(
            "Undersoft",
            IconVariant.Regular,
            IconSize.Custom,
