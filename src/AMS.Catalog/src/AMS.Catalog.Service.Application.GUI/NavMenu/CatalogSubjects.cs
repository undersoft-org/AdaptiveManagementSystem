...
public class CatalogSubjects : DataObject
{
    ...
    public string Elements { get; set; } = "/catalog/subjects/elements";
    ...
    public string Procedures { get; set; } = "/catalog/subjects/procedures";
    ...
    public string Workflows { get; set; } = "/catalog/subjects/workflows";
    ...
    public string Categories { get; set; } = "/catalog/subjects/categories";
    ...
    public string Groups { get; set; } = "/catalog/subjects/groups";
