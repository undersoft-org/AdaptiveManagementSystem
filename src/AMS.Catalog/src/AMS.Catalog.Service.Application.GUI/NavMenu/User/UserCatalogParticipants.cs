...
public class AdminCatalogParticipants : DataObject
{
    ...
    public string Members { get; set; } = "/user/catalog/participants/members";
    ...
    public string Contractors { get; set; } = "/user/catalog/participants/contractors";
    ...
    public string Environments { get; set; } = "/user/catalog/participants/environments";
