...
public class CatalogResources : DataObject
{
    [Link]
    [MenuItem]
    [Extended]
    [DisplayRubric("Files")]
    public string Files { get; set; } = "/catalog/resources/files";
    ...
    public string Images { get; set; } = "/catalog/resources/images";
    ...
    public string Models { get; set; } = "/catalog/resources/models";
    ...
    public string Events { get; set; } = "/catalog/resources/events";
