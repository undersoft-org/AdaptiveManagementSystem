...
using Undersoft.AMS.Catalog.Service.Application.GUI.Compound.Presenting.NavMenu.User.Markets;
using Undersoft.SDK.Rubrics.Attributes;
using Undersoft.SDK.Service.Application.GUI.View.Attributes;
using Undersoft.SDK.Service.Data.Object;

namespace Undersoft.AMS.Catalog.Service.Application.GUI.Compound.Presenting.NavMenu.User;
