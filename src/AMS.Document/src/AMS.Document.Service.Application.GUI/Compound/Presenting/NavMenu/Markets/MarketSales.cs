...
public class MarketSales : DataObject
{
    ...
    public string Offers { get; set; } = "/presenting/market/sales/offers";
    ...
    public string Orders { get; set; } = "/presenting/market/sales/orders";
    ...
    public string Processes { get; set; } = "/presenting/market/sales/processes";
    ...
    public string Transactions { get; set; } = "/presenting/market/sales/transactions";
    ...
    public string Events { get; set; } = "/presenting/market/sales/events";
