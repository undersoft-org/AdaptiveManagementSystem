...
namespace Undersoft.AMS.Document.Service.Application.GUI.Compound.Presenting.NavMenu.Markets;
...
public class MarketProduces : DataObject
{
    ...
    public string Offers { get; set; } = "/presenting/market/produces/offers";
    ...
    public string Orders { get; set; } = "/presenting/market/produces/orders";
    ...
    public string Processes { get; set; } = "/presenting/market/produces/processes";
    ...
    public string Transactions { get; set; } = "/presenting/market/produces/transactions";
    ...
    public string Events { get; set; } = "/presenting/market/produces/events";
