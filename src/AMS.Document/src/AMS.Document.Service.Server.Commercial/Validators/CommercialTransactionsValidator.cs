...
namespace Undersoft.AMS.Catalog.Service.Server.Subjects.Validators
{
    ...
    public class CommercialTransactionsValidator : CommandSetValidator<CommercialTransaction>
    {
        public CommercialTransactionsValidator(IServicer servicer) : base(servicer)
        {
            ValidationScope(
                OperationKind.Any,
                () =>
