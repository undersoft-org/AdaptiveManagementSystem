...
namespace Undersoft.AMS.Catalog.Service.Server.Subjects.Validators
{
    ...
    public class FinancialTransactionsValidator : CommandSetValidator<FinancialTransaction>
    {
        public FinancialTransactionsValidator(IServicer servicer) : base(servicer)
        {
            ValidationScope(
                OperationType.Any,
                () =>
