...
namespace Undersoft.AMS.Project.Service.Application.GUI.Compound;

/// <summary>
/// The logo SCC.
/// </summary>
public class AMSProjectLogo : Icon
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AMSProjectLogo"/> class.
    /// </summary>
    public AMSProjectLogo()
      : base(
            "Undersoft",
            IconVariant.Regular,
            IconSize.Custom,
