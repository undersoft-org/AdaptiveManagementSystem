...
namespace Undersoft.AMS.Market.Service.Application.GUI.Compound.Graphic;

/// <summary>
/// The logo SCC.
/// </summary>
public class LogoAll.Market : Icon
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LogoAll.Market"/> class.
    /// </summary>
    public LogoAll.Market()
        : base(
            "Undersoft",
            IconVariant.Regular,
            IconSize.Custom,
