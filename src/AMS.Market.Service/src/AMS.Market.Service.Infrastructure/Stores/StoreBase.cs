...
using Undersoft.AMS.Market.Domain.Entities.Inventory;
using Undersoft.AMS.Market.Domain.Entities.Vaccination;
using Undersoft.AMS.Market.Service.Infrastructure.Stores.Mappings;

namespace Undersoft.AMS.Market.Service.Infrastructure.Stores
{
    /// <summary>
    /// The store base.
    /// </summary>
