...
namespace Undersoft.AMS.Document.Service.Application.GUI.Compound.Graphic;

/// <summary>
/// The logo SCC.
/// </summary>
public class LogoAll.Document : Icon
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LogoAll.Document"/> class.
    /// </summary>
    public LogoAll.Document()
        : base(
            "Undersoft",
            IconVariant.Regular,
            IconSize.Custom,
